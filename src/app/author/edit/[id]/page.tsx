...
import PublishModal from '../../../../components/author-ui/publish_popup';
import SaveModal from '../../../../components/author-ui/save_modal';
import ErrorModal from '../../../../components/author-ui/publish_error_popup';
import SettingsModal from '../../../../components/author-ui/settings_modal';
...
const QuizCreator: React.FC = () => {
  ...
  async function fetchData(id: string) {
    ...
    try {
      ...
      console.log(quiz);
      // setQuizData(quiz);
      // console.log('my_quiz_data', quizData);
      setId(quiz.id);
      setQuizTitle(quiz.quiz_title);
      setQuizDescription(quiz.description);
      setQuizDuration(quiz.est_time_to_complete);
      setQuestions(Object.values(quiz.questions));
      setSelectedCategory(quiz.course);
      const metadata = {
        quiz_title: quiz.quiz_title,
        description: quiz.description,
        course: quiz.course,
        est_time_to_complete: quiz.est_time_to_complete,
      };
  ...
  async function updateDocument(quizData: QuizData): Promise<void> {
  ...
  return (
    <>
      <div className="min-h-screen bg-gray-100">
        <div className="mx-20 mb-6 h-6 px-5 pt-10 xs:mx-5 md:mx-20">
          <span className="text-base font-normal text-black">
            Dashboard &gt;{' '}
            <span className="text-base font-normal text-black">Edit Quiz</span>{' '}
            &gt;{' '}
            <span className="text-base font-bold text-black">{quizTitle}</span>
          </span>
        </div>
        <div className="mb-4 mt-0 px-4 sm:px-2 sm:py-4 md:px-8 lg:px-16 xl:px-24">
          ...
          <p className=" mt-4 text-sm text-gray-600 xs:mb-10">
          ...
          >
            ...
            >
              <div className="flex-1">
                ...
                <div className="md-w-full mb-4 flex flex-col items-start 2xs:w-1/2 xs:w-full xs:items-start md:flex-row md:items-center md:justify-between">
                  <input
                    type="text"
                    placeholder={
