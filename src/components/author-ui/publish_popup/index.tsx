...
const PublishModal: FC<ModalProps> = ({
  isOpen,
  onClose,
  onSubmit,
  quizTitle,
  ...
  const handleFormSubmit = (event: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!quizTitle || !quizDescription || !quizDuration || !selectedCategory) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="z-10 w-full max-w-lg transform overflow-hidden rounded-lg bg-white p-8 shadow-xl transition-all">
        ...
        <p className="mb-6 text-center text-black">
          ...
          publishing it with the correct details to ensure your quiz is
          published and categorized correctly.
        </p>
